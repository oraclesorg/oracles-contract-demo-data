...
contract DemoData is KeyClass, ValidatorClass, BallotClass {
    ...
    address[] private demoPayoutKeys = [demoValidators[0]];
    address[] private demoVotingKeys = [demoValidators[0]];
    uint[] private demoBallots = [11749347, 29908500, 37079255, 23661745];
    address[] private demoBallotsKeys = [0x5bf25597c2dc66d7f7153b22237962aed7461391, 0xbb232c047d99d39eab8543de8e913a01af85aed0, 0x0083d7E016DEb94836443aAF997f63DcA13cd66f, demoDisabledValidators[0]];
    ...
    function DemoData() {
        ...
        miningKeys[demoValidators[0]] = MiningKey({isActive: true});
        payoutKeys[demoValidators[0]] = PayoutKey({isActive: true});
        votingKeys[demoValidators[0]] = VotingKey({isActive: true});
        ...
        validator[demoDisabledValidators[0]] = Validator({
        ...
        validator[demoInitialKeys[0]] = Validator({
        ...
        validator[demoValidators[0]] = Validator({
        ...
        ballotsMapping[demoBallots[0]] = Ballot({
            owner: msg.sender,
            miningKey: demoBallotsKeys[0],
            affectedKey: demoBallotsKeys[0],
        ...
        ballotsMapping[demoBallots[1]] = Ballot({
            owner: msg.sender,
            miningKey: demoBallotsKeys[1],
            affectedKey: demoBallotsKeys[1],
        ...
        ballotsMapping[demoBallots[2]] = Ballot({
            owner: msg.sender,
            miningKey: demoBallotsKeys[2],
            affectedKey: demoBallotsKeys[2],
        ...
        ballotsMapping[demoBallots[3]] = Ballot({
            owner: msg.sender,
            miningKey: demoBallotsKeys[3],
            affectedKey: demoBallotsKeys[3],
